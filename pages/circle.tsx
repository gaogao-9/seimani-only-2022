    ...
    <Layout>
      ...
      >
        <Card title="サークル参加をする方へ">
          ...
          <Card.Section title="神奈川県青少年保護育成条例について">
            本イベントは、神奈川県青少年保護育成条例および同施行規則に則った形での運営を行います。
            <br />
            そのため、成人向け作品を頒布されるサークルの皆さんには、以下の点にご協力をお願いいたします。
            <br />
            ・成人向け作品を頒布する場合、必ず相手の年齢確認を行なってください。
            <br />
            ・18歳未満への頒布を行わない旨を明示する紙を入場時にお配りします。頒布時間中はその紙を該当作品のそばに必ず掲示してください。
          </Card.Section>
